      ...
      <aside class="w-80 border-r border-zinc-200 p-4 overflow-y-auto bg-white hidden md:block">
        <div class="mb-3">
          <input 
            ...
            class="w-full bg-white border border-zinc-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-600 focus:border-blue-600 transition" 
          />
        </div>
        <div class="space-y-3">
          <button
      ...
      <aside class="w-[360px] border-r border-zinc-200 p-4 space-y-4 bg-zinc-50 hidden lg:block">
        ...
        <section>
          <div class="flex items-center justify-between mb-2">
            ...
            <button class="text-xs px-2.5 py-1.5 rounded-lg bg-white border border-zinc-300 shadow-sm hover:shadow">
              Edit Steps
            </button>
          </div>
          <div class="space-y-2">
        ...
        <div class="px-5 py-3 border-t border-zinc-200 bg-white">
          <div class="max-w-5xl mx-auto">
            <div class="flex items-center justify-between">
              ...
              <button class="text-xs px-2 py-1 rounded-md bg-zinc-100 hover:bg-zinc-200 border border-zinc-300 text-zinc-700" @click="loadExecutions">
                Refresh
              </button>
            </div>
      ...
      <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md p-6">
        ...
        <div class="mt-6 flex justify-end gap-2">
          <template v-if="uploadDialog.type === 'success'">
            ...
            <button class="px-3.5 py-1.5 text-sm rounded-md bg-zinc-200 hover:bg-zinc-300 text-zinc-900 shadow-sm" @click="closeDialog">
              Close
            </button>
          </template>
          <template v-else>
